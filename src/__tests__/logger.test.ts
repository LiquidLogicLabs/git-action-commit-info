...
describe('Logger', () => {
	...
	describe('with verbose enabled and debugMode disabled', () => {
	...
	describe('with debugMode enabled (verbose=false)', () => {
		...
		it('should log verboseInfo messages using core.info() since verbose is implied', () => {
			logger.verboseInfo('Verbose message');
			expect(core.info).toHaveBeenCalledWith('Verbose message');
		});
	...
	describe('with both verbose and debugMode enabled', () => {
		...
		it('should log verboseInfo messages using core.info()', () => {
			logger.verboseInfo('Verbose message');
			expect(core.info).toHaveBeenCalledWith('Verbose message');
		});
	...
	describe('default constructor', () => {
		...
		it('should not log verboseInfo messages by default', () => {
			const logger = new Logger();
